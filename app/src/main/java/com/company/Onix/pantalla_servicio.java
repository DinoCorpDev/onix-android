...
=======
>>>>>>> e60555398cae704a1471f6f204f64b9696c358c2
        ...
        mBtn_cancelar_servicio.setOnClickListener(v -> {
            if (mEstado != null) {
                if (mEstado.equals("El conductor cancelo el servicio")) {
                    ...
                    if (mEstado.equals("confirmado") || mEstado.equals("aceptado")) {
                        ...
                        Toast.makeText(pantalla_servicio.this,
                                "El servicio esta en curso no puedes cancelarlo",
        ...
        mBtn_llamar_dos.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void saveCanceled(String title, String motivo) {
        try {
            ...
            mDatabaseReferencesRecordDay = FirebaseDatabase.getInstance().getReference()
                    .child(title)
                    .child(ciudad)
            ...
            registro.put("telefono_conductor", mtelefono_conductor);
            //acutalizamos el registro con update children
            mDatabaseReferencesRecordDay.updateChildren(registro);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void drawRoute() {
        ...
        if (mCliente_posicion != null && mDriverLatLng != null) {
            mMap.addMarker(new MarkerOptions().position(mCliente_posicion).title("Usuario").icon(BitmapDescriptorFactory.fromResource(R.drawable.icono_ubicar_dos)));
